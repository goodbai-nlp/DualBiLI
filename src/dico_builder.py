...
def get_candidates(emb1, emb2, params):
    ...
    # contextual dissimilarity measure
        ...
        average_dist1 = torch.from_numpy(get_nn_avg_dist(emb2, emb1, knn, device_id=params.cuda_device))
        average_dist2 = torch.from_numpy(get_nn_avg_dist(emb1, emb2, knn, device_id=params.cuda_device))
...
def build_dictionary(src_emb, tgt_emb, params, s2t_candidates=None, t2s_candidates=None):
    ...
    return dico.cuda() if torch.cuda.is_available() else dico
